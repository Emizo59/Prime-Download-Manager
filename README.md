...
&nbsp;
[![Version](https://img.shields.io/badge/version-1.0_Beta_5-22c55e?style=for-the-badge)](https://github.com/Emizo59/Prime-Download-Manager/releases/latest/download/Prime_Download_Manager_Setup.exe)
&nbsp;
...
- 🎥 More reliable video extraction and playlist detection.
- 🔄 Smoother self-update and safer download-merge handling.
- 🔐 Credentials are now encrypted at rest on every platform.

### 🐞 Recently fixed
- Orphaned merge processes after an abrupt exit.
- Playlist queue display and download integrity (short-write detection).
- Many stability and UI polish fixes.
...
![Build](https://img.shields.io/badge/build-006-2563eb?style=flat-square) &nbsp; [Privacy Policy](https://emizo59.github.io/download-manager/privacy-policy)
